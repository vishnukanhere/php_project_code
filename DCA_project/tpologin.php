...
$sql = "SELECT * FROM tpologin WHERE username = '$username' and password = '$password'";
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-RED">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link  mx-3 text-BLACK fs-5" href="tpologin.php"><u> TPO login</u></a>
                </li>
        ...
        <div style="border:solid 2px WHITE;min-height:450px ">
          ...
          <form method="POST">
            <div class="mb-3">
              ...
              <input type="username" class="form-control" id="username" aria-describedby="emailHelp" name="txtUser">
