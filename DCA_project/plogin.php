...
$sql = "SELECT * FROM principallogin WHERE username = '$username' and password = '$password'";
      ...
      if($count>0)
      {
        ...
        header("location:principlepage.php");
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-RED">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  mx-3 text-black fs-5" href="plogin.php"><u> Principle login </u></a>
                                </li>
                                <li class="nav-item">
...
<form  method="post">
  <div class="mb-3">
    ...
    <input type="username" name="txtUser" class="form-control" id="exampleInputusername" aria-describedby="emailHelp">
    <div class="mb-3">
  ...
  <button type="button" class="btn btn-outline-primary"><a class="nav-link" href="principlepage.php">Submit</a></button> -->
